...
This is the functions from Book class
*/
...
//assembling book object into a string
const string* Book::getFields() {
	const string fields[8] = { "isbn", "title", "author", "publisher", "dateAdded", "quantityOnHand", "wholesaleCost", "retailPrice" };
	return fields;
}
const string* Book::getHumanReadableFields() {
	const string humanReadableFields[8] = { "ISBN", "Title", "Author", "Publisher", "Date added", "Quantity on hand", "Wholesale cost", "Retail price" };
